...
class SpotifyDataCollector:
    ...
    def get_top_genres(self, limit=15):
        ...
        popular_genres = [
            ...
            "latin", "indie", "r&b", "country", "folk",
            "metal", "jazz", "blues", "reggae", "punk",
            "classical", "alternative", "disco", "soul", "funk"
        ]
    ...
    def get_album_details(self, album_id):
        ...
        if response.status_code == 200:
            ...
            album = {
                ...
                "cover_image": album_data["images"][0]["url"] if album_data["images"] else "",
                "songs": []
            }
    ...
    def collect_all_data(self):
        ...
        for genre in genres:
            ...
            for artist in artists[:50]:  # Limit to 50 artists per genre
